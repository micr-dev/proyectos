...
export const mcpsSkillsBatch = {
  ...
  "chatgpt-webui-mcp": {
    paragraphs: [
      "chatgpt-webui-mcp automatiza chatgpt.com a través de camofox para que los clientes de MCP puedan ejecutar prompts de ChatGPT 4o, generación de imágenes e investigación de larga duración sin manipulación manual del navegador.",
  ...
  "minecraft-server-skill": {
    paragraphs: [
      "minecraft-server-skill es una habilidad de Codex para desplegar, endurecer y operar servidores de Minecraft Java en Linux, cubriendo Vanilla, Fabric, Paper, Forge y Folia.",
      "La mayoría de guías tratan Minecraft como un lanzamiento de jar desechable, dejando que los operadores descubran por su cuenta la integración con systemd, el alcance del firewall, el ajuste de JVM y las rutinas de respaldo.",
      "Descubre los datos del host antes de hacer preguntas, verifica las descargas a través de APIs oficiales, ejecuta bajo un usuario dedicado con systemd y valida el servidor terminado revisando el estado del servicio, puertos, lista blanca y carga de mods.",
    ],
    languages: ["Python", "Markdown"],
  },
  "gitquarry-mcp": {
    paragraphs: [
      "gitquarry-mcp es un servidor MCP stdio en Rust que envuelve el CLI de gitquarry, exponiendo herramientas de búsqueda, inspección, árbol, código y autenticación sin reimplementar la lógica del producto.",
      "Los clientes MCP necesitaban la búsqueda estructurada y la inspección de código de gitquarry en su bucle de herramientas, pero duplicar el comportamiento del CLI en proceso rompería la paridad con las credenciales y las actualizaciones.",
      "Usa rmcp con JSON Schema generado automáticamente a partir de tipos Rust, invoca el binario gitquarry instalado y expone todos los parámetros como argumentos nativos de MCP.",
    ],
    languages: ["Rust"],
  },
  "claude-skills": {
